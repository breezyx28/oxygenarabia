...
const BackgroundBoxesLayout = lazy(() =>
  import("@/layouts/styled-layouts/boxes-bg-layout").then((m) => ({
    default: m.BackgroundBoxesLayout,
  }))
);
  ...
  return (
    <>
      ...
      <section className="section-container flex flex-col justify-around">
        ...
        <div className="container w-full mx:px-6 px-12 py-12 mx-auto flex justify-center">
          <Suspense
            fallback={
          ...
          <Suspense
            fallback={
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-gray-100 animate-pulse h-48 rounded"></div>
                <div className="bg-gray-100 animate-pulse h-48 rounded"></div>
                <div className="bg-gray-100 animate-pulse h-48 rounded"></div>
              </div>
            }
        ...
        <div className="container px-6 py-10">
          <div className="event-gallary-wrapper w-full h-auto">
            <div className="latest-event flex flex-col gap-y-6">
              ...
              <div className="event-wrapper md:p-8 p-0 md:bg-slate-200 bg-white rounded-[1rem]">
                <Suspense
                  fallback={
      ...
      <section className="section-container flex md:flex-row flex-col gap-y-8 justify-between">
        <div className="container px-6">
          <div className="section-text">
            {t("projectsPage.achievementSection.title")}{" "}
            <span className="text-primary">
              {t("projectsPage.achievementSection.titleHighlight")}
            </span>
          </div>
